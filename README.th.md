...
บนหน้าจอเดสก์ท็อป ตัวเลือกโหมดเปรียบเทียบ/จัดอันดับจะอยู่บนแถบด้านบน ส่วน **การนำทางด่วน** จะอยู่ในแถบขนาดเล็กริมซ้ายสุด เปิดปุ่ม **หัวข้อ** เพื่อไปยัง IP ปัจจุบัน การปรับปรุงข้อมูล การเพิ่ม IP รายการจุด หรือส่วนสาธิตได้ทันที แถบควบคุมหลักจึงเริ่มต้นด้วยส่วนที่ใช้งานจริง สำหรับหน้าจอขนาดกลาง ปุ่มหัวข้อจะอยู่บนแถบด้านบน และหน้าจอมือถือจะแสดงเมนูแนวตั้งภายในแถบซ้าย โดยรูปข้าวหลามตัดขนาดเล็กจะระบุส่วนที่กำลังเปิดอยู่
