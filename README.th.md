...
คลังซอร์สโค้ดมีไฟล์ `netlify.toml` ที่พร้อมใช้งาน เชื่อมต่อคลังซอร์สโค้ด เพิ่ม `IP2LOCATION_API_KEY` เป็นตัวแปรสภาพแวดล้อมฝั่งเซิร์ฟเวอร์ แล้วเผยแพร่ด้วยค่าต่อไปนี้
...
ห้ามบันทึก `.env`, `.env.local`, `node_modules`, API Key หรือข้อมูลลับอื่นลงใน Git รายละเอียดการตรวจสอบข้อจำกัดอัตราการเรียกใช้ แคช และโควตาอยู่ใน [รายการตรวจสอบก่อนเผยแพร่](docs/RELEASE-CHECKLIST.md)
...
ควรรันคำสั่งทั้งสองก่อนส่งผลงาน ปัจจุบันชุดทดสอบอัตโนมัติมี 45 รายการ อย่างไรก็ตาม การตรวจสอบ HTTP, DNS และ API ต้นทางใช้ข้อมูลจำลอง จึงยังต้องตรวจสอบระบบที่เผยแพร่จริงด้วยตนเอง

เอกสารประกอบ:

- [คู่มือการใช้งานฉบับละเอียดและแนวทางบันทึกภาพหน้าจอ](docs/USER-GUIDE.th.md)
- [รายการตรวจสอบก่อนเผยแพร่](docs/RELEASE-CHECKLIST.md)
- [บันทึกผลการตรวจสอบ](docs/VALIDATION.md)
- [สารบัญเอกสาร](docs/README.th.md)
