...
บนหน้าจอเดสก์ท็อป ระบบย้ายตัวเลือกโหมดเปรียบเทียบ/จัดอันดับและเมนู **การนำทางด่วน** ไปไว้บนแถบด้านบน เพื่อให้แถบซ้ายเริ่มต้นด้วยส่วนควบคุมการทำงาน ผู้ใช้เปิดเมนูเพื่อไปยัง IP ปัจจุบัน การปรับปรุงข้อมูล การเพิ่ม IP รายการจุด หรือส่วนสาธิตได้ทันที ส่วนหน้าจอมือถือแบบเรียงซ้อนจะแสดงเมนูแนวตั้งไว้ในแถบซ้าย โดยรูปข้าวหลามตัดขนาดเล็กจะระบุส่วนที่กำลังเปิดอยู่
