...
เมนู **การนำทางด่วน** แบบแนวตั้งจะตรึงอยู่ด้านบนของแถบซ้าย ผู้ใช้สามารถเลือกเพื่อไปยัง IP ปัจจุบัน การปรับปรุงข้อมูล การเพิ่ม IP รายการจุด หรือส่วนสาธิตได้ทันที เมนูใช้ชื่อรายการที่ชัดเจน และแสดงรูปข้าวหลามตัดขนาดเล็กเฉพาะส่วนที่กำลังเปิดอยู่
