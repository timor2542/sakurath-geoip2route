...
| เอกสาร | เหมาะสำหรับ |
|---|---|
| [คู่มือการใช้งาน](docs/USER-GUIDE.th.md) | เรียนรู้ขั้นตอนการใช้งานพร้อมภาพประกอบจากแอปพลิเคชัน |
| [หลักการและอัลกอริทึม](docs/ALGORITHM.th.md) | ทำความเข้าใจวิธีคำนวณระยะทาง หลักฐาน HTTP และคะแนนจัดอันดับ |

ฉบับภาษาอังกฤษ: [User Guide](docs/USER-GUIDE.md) · [Algorithm](docs/ALGORITHM.md)
...
ศึกษาขั้นตอนทั้งหมดพร้อมภาพหน้าจอได้จาก [คู่มือการใช้งาน](docs/USER-GUIDE.th.md)
...
ศึกษาสมการ ขั้นตอนการคำนวณ ข้อสมมติ และข้อจำกัดทั้งหมดได้จาก [หลักการและอัลกอริทึม](docs/ALGORITHM.th.md)
