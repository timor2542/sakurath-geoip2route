...
test('contest demo and modal controls remain usable on small screens and keyboards', () => {
  ...
  assert.match(app, /id="section-rail-panel" class="section-rail-panel sidebar-jump-nav"/)
  ...
  assert.match(readability, /\.section-rail-panel \{[^}]*position: absolute;[^}]*left: calc\(100% \+ 8px\);/)
