...
2. **แผงด้านซ้ายบน** — เลือกโหมดและใช้ส่วนควบคุมหลักสำหรับการเปรียบเทียบหรือจัดอันดับ
3. **แผงจุดบนแผนที่ด้านซ้ายล่าง** — เพิ่มหรือนำเข้า IP แล้วเลือก A/B หรือ IP อ้างอิง โดยเลื่อนเฉพาะรายการได้โดยไม่ทำให้หน้าหลักเลื่อนตาม
4. **พื้นที่ตรงกลาง** — แสดงแผนที่ หมุด เส้น Grid มาตราส่วน และปุ่มซูม โดยมี **บันทึกกิจกรรม (Activity Console)** อยู่ด้านล่าง
5. **แถบด้านขวา** — แสดงผลเปรียบเทียบหรือผลจัดอันดับโดยละเอียด
...
> **ภาพที่ควรถ่าย 1 — ภาพรวมแอป:** ใช้หน้าจอเดสก์ท็อปแนวนอน โดยให้เห็นแผงควบคุมด้านซ้ายบน แผงจุดบนแผนที่ด้านซ้ายล่าง แผนที่ แถบด้านขวา และบันทึกกิจกรรมภายในภาพเดียว พร้อมใส่หมายเลขกำกับ 1–5 ตามส่วนประกอบข้างต้น
...
> **ภาพที่ควรถ่าย 3 — เพิ่ม IP:** ตัดภาพแผงด้านซ้ายบนให้เห็นปุ่ม Add current IP และแผงด้านซ้ายล่างให้เห็นช่องเพิ่ม IP พร้อมใส่หมายเลขกำกับช่องกรอก ปุ่ม `+` และข้อความสถานะ
