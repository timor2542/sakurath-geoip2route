...
บนหน้าจอเดสก์ท็อป ตัวเลือกโหมดเปรียบเทียบ/จัดอันดับและเมนู **การนำทางด่วน** จะอยู่บนแถบด้านบน ทำให้แถบซ้ายเริ่มต้นด้วยส่วนควบคุมการทำงาน เปิดเมนูแล้วเลือก IP ปัจจุบัน ปรับปรุงข้อมูล เพิ่ม IP รายการจุด หรือส่วนสาธิต เพื่อเลื่อนไปยังส่วนนั้นทันที สำหรับหน้าจอมือถือแบบเรียงซ้อน ตัวเลือกเดียวกันจะแสดงเป็นเมนูแนวตั้งในแถบซ้าย รูปข้าวหลามตัดขนาดเล็กจะแสดงส่วนที่กำลังเปิดอยู่
