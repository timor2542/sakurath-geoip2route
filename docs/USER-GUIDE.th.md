...
> **ภาพที่ควรถ่าย 1 — ภาพรวมแอป:** ใช้หน้าจอเดสก์ท็อปแนวนอน โดยให้เห็นแถบด้านซ้าย แผนที่ แถบด้านขวา และบันทึกกิจกรรมภายในภาพเดียว พร้อมใส่หมายเลขกำกับ 1–4 ตามส่วนประกอบข้างต้น
...
## 15. รายการตรวจสอบสำหรับจัดทำภาพใน Photoshop

1. ใช้ความละเอียดเดียวกันทุกภาพ เช่น `1920×1080`
2. กำหนดการซูมของเบราว์เซอร์เป็น 100% และเลือกปุ่ม Fit all points ก่อนบันทึกภาพแผนที่
...
5. ตัดภาพให้เห็นชื่อหัวข้อก่อนเพิ่มลูกศรหรือหมายเลขกำกับ
6. ใช้สีของคำกำกับให้ตรงกับส่วนติดต่อผู้ใช้ ได้แก่ สีชมพูสำหรับ A หรืออันดับหนึ่ง สีเหลืองสำหรับ B และสีเขียวสำหรับ `SRC`
7. ไม่ควรปิดบังข้อความระบุแหล่งที่มาของ Leaflet/OpenStreetMap
8. ปิดบัง API Key, โทเคน, URL ภายใน และข้อมูลส่วนบุคคลก่อนเผยแพร่
9. หลีกเลี่ยงการแต่งตัวเลขผลลัพธ์จนต่างจากค่าที่แอปแสดงจริง
10. ตรวจสอบการสะกด วันที่ เวอร์ชัน และลิงก์ก่อนส่งออกภาพ
