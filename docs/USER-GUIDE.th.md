...
เมนู **การนำทางด่วน** แบบแนวตั้งซึ่งตรึงอยู่ด้านบนของแถบซ้ายมีตัวเลือกข้อความห้ารายการ ได้แก่ IP ปัจจุบัน ปรับปรุงข้อมูล เพิ่ม IP รายการจุด และส่วนสาธิต เมื่อเลือกชื่อ ระบบจะเลื่อนไปยังส่วนนั้นทันที รูปข้าวหลามตัดขนาดเล็กจะแสดงเฉพาะส่วนที่กำลังเปิดอยู่และเปลี่ยนตามตำแหน่งการเลื่อน
