...
แถบ **ไปยัง** ซึ่งตรึงอยู่ด้านบนของแถบซ้ายมีทางลัดห้าปุ่ม เรียงจากซ้ายไปขวา ได้แก่ IP ปัจจุบัน ปรับปรุงข้อมูล เพิ่ม IP รายการจุด และส่วนสาธิต เมื่อเลือกไอคอน ระบบจะเลื่อนไปยังส่วนนั้นทันที ผู้ใช้สามารถชี้เมาส์เพื่ออ่านชื่อเต็มได้ และโปรแกรมอ่านหน้าจอจะอ่านชื่อเดียวกันตามภาษาที่เลือก
...
> **ภาพที่ควรถ่าย 1 — ภาพรวมแอป:** ใช้หน้าจอเดสก์ท็อปแนวนอน โดยให้เห็นแถบทางลัด “ไปยัง” แถบด้านซ้าย แผนที่ แถบด้านขวา และบันทึกกิจกรรมภายในภาพเดียว พร้อมใส่หมายเลขกำกับส่วนประกอบ และแสดงลำดับในแถบซ้ายตั้งแต่ Add current IP ถึง Map Points
