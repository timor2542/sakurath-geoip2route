...
บนหน้าจอเดสก์ท็อป ตัวเลือกโหมดเปรียบเทียบ/จัดอันดับจะอยู่บนแถบด้านบน ส่วน **การนำทางด่วน** จะเป็นแถบไอคอนริมซ้ายสุด ไอคอนทั้งห้ารายการใช้สำหรับไปยัง IP ปัจจุบัน ปรับปรุงข้อมูล เพิ่ม IP รายการจุด และส่วนสาธิต ค่าเริ่มต้นจะแสดงเฉพาะไอคอน โปรดกดไอคอนเมนูด้านบนเพื่อขยายแถบและแสดงชื่อทั้งหมด แผงหลักด้านซ้ายจึงเริ่มต้นด้วยส่วนควบคุมการทำงาน สำหรับหน้าจอขนาดกลาง ปุ่มหัวข้อจะอยู่บนแถบด้านบน ส่วนหน้าจอมือถือจะแสดงตัวเลือกเป็นเมนูแนวตั้งภายในแถบซ้าย
