...
บนหน้าจอเดสก์ท็อป ตัวเลือกโหมดเปรียบเทียบ/จัดอันดับจะอยู่บนแถบด้านบน ส่วน **การนำทางด่วน** จะอยู่ในแถบขนาดเล็กริมซ้ายสุด เปิดปุ่ม **หัวข้อ** แล้วเลือก IP ปัจจุบัน ปรับปรุงข้อมูล เพิ่ม IP รายการจุด หรือส่วนสาธิต เพื่อเลื่อนไปยังส่วนนั้นทันที แผงหลักด้านซ้ายจึงเริ่มต้นด้วยส่วนควบคุมการทำงาน สำหรับหน้าจอขนาดกลาง ปุ่มหัวข้อจะอยู่บนแถบด้านบน ส่วนหน้าจอมือถือจะแสดงตัวเลือกเป็นเมนูแนวตั้งภายในแถบซ้าย รูปข้าวหลามตัดขนาดเล็กจะแสดงส่วนที่กำลังเปิดอยู่
