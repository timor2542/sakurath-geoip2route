...
Use the sticky **Quick navigation** menu to jump directly to Current IP, Update, Add IP, Points, or Demo. The menu uses full text labels instead of repeated icons.
