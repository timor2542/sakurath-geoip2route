...
Use the sticky, vertical **Quick navigation** menu to jump directly to Current IP, Update, Add IP, Points, or Demo. It uses clear text labels and marks the current section with one small diamond.
